...
export const FlightCompass: React.FC<CompassProps> = ({ yawDeg }) => {
  ...
  return (
    <div className="flex items-center justify-center p-6">
      ...
      <div className="relative flex size-80 items-center justify-center overflow-hidden rounded-[48px] border border-white/10 bg-black/50 p-6 shadow-2xl backdrop-blur-xl">
        
        {/* COMPASS DIAL RADIAL AREA */}
        <div className="relative h-full w-full rounded-full border border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent">
          ...
          >
            ...
            {/* NORTH */}
            <div className="absolute left-1/2 top-4 -translate-x-1/2 text-2xl font-bold tracking-tighter text-red-500">
              N
            </div>
            {/* SOUTH */}
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-2xl font-medium tracking-tighter text-white/80">
              S
            </div>
            {/* WEST */}
            <div className="absolute left-4 top-1/2 -translate-y-1/2 text-2xl font-medium tracking-tighter text-white/80">
              W
            </div>
            {/* EAST */}
            <div className="absolute right-4 top-1/2 -translate-y-1/2 text-2xl font-medium tracking-tighter text-white/80">
              E
            </div>
          </div>
          ...
          <div className="absolute left-1/2 top-1/2 z-10 flex h-20 w-28 -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-2xl border border-white/10 bg-zinc-950/80 shadow-lg shadow-black/40 backdrop-blur-md">
