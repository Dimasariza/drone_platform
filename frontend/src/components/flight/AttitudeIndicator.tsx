    ...
    <div className="flex items-center justify-center p-6">
      ...
      <div className="relative flex size-80 items-center justify-center overflow-hidden rounded-[48px] border border-white/10 bg-black/50 p-6 shadow-2xl backdrop-blur-xl">
        ...
        <div className="relative h-full w-full overflow-hidden rounded-full border border-zinc-700 bg-zinc-950">
          ...
          >
            {/* Sky (Blue) */}
            <div className="absolute inset-x-[-50%] top-[-50%] h-[100%] w-[200%] bg-[#38bdf8]" />
            
            {/* Ground (Brown) */}
            <div className="absolute inset-x-[-50%] top-[50%] h-[100%] w-[200%] bg-[#a16207]" />
            
            {/* Horizon Center Line */}
            <div className="absolute top-1/2 left-[-50%] h-[4px] w-[200%] -translate-y-1/2 bg-white" />
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center font-sans font-bold text-white text-[11px]">
              {/* Pitch +30 */}
              <div className="absolute flex items-center justify-between w-36 -translate-y-[120px]">
                <span>30</span>
              ...
              {/* Pitch +20 */}
              <div className="absolute flex items-center justify-between w-28 -translate-y-[80px]">
                <span>20</span>
              ...
              {/* Pitch +10 */}
              <div className="absolute flex items-center justify-between w-20 -translate-y-[40px]">
                <span>10</span>
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none">
            <svg width="180" height="40" viewBox="0 0 180 40" fill="none">
              ...
              />
              {/* Center Spec Node */}
              <circle cx="90" cy="20" r="3.5" fill="#facc15" />
              {/* Right Wing Bar */}
              <path
